            ...
            <div className="container" style={{ position: "relative" }}>
                ...
                <div style={{
                    ...
                    <span style={{ color: "#7bcfff", fontSize: 13, fontWeight: 600, letterSpacing: "0.04em" }}>
                        B2B-каталог лёгкой промышленности Узбекистана
                    </span>
                </div>
                <div style={{
                    display: "grid",
                    ...
                    <div>
                        <h1 style={{
                            ...
                            Найдите надёжного производителя{" "}
                            <span style={{
                                background: "linear-gradient(90deg, #5eb8ff, #0e7bc4)",
                        ...
                        <p style={{
                            ...
                            Более 500 проверенных фабрик. Готовый товар, пошив под ваш бренд и производство по вашим лекалам — всё в одном месте.
                        </p>
                        ...
                        <div style={{
                            ...
                            <input
                                type="text"
                                placeholder="Худи, футболки, ковры, обувь..."
                                style={{
                                    flex: 1,
                                    border: "none",
                                    outline: "none",
                        ...
                        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
                            <span style={{ fontSize: 13, color: "rgba(255,255,255,0.5)" }}>Популярно:</span>
                            {["Худи оверсайз", "Постельное бельё", "Спортивный трикотаж", "Мужские рубашки"].map(tag => (
                        ...
                        {[
                            {
                                ...
                                title: "Готовый товар",
                                desc: "Купите готовую партию со склада уже сейчас",
                                badge: "In-Stock",
                                badgeColor: "#16a34a",
                                href: "/products?type=instock",
                                btnLabel: "Смотреть каталог",
                            },
                            {
                                IconComp: () => <NeonTagIcon size={32} color="cyan" />,
                                title: "Своя бирка (White Label)",
                                desc: "Закажите пошив любой модели под ваш бренд",
                                badge: "White Label",
                                badgeColor: "#0e7bc4",
                                href: "/products?type=whitelabel",
                                btnLabel: "Найти фабрику",
                            },
                            {
                                IconComp: () => <NeonRFQIcon size={32} color="purple" />,
                                title: "Производство по ТЗ (RFQ)",
                                desc: "Загрузите лекала — фабрики пришлют КП",
                                badge: "RFQ",
                                badgeColor: "#7c3aed",
                                href: "/rfq/new",
                                btnLabel: "Разместить заказ",
                            },
                        ].map(card => (
